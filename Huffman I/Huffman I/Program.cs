...
namespace Huffman_I
{
    class Node
    {
        ...
        public long Weight { get; }    // Weight of a current node.
        ...
        /// <summary>
        /// Creates a new LEAF NDOE. If you intend to create a new internal node, use other overload or call this overload with ch == -1.
        /// </summary>
        /// <param name="weight">Weight of the new node.</param>
        /// <param name="charValue">CharValue of the new node.</param>
        public Node(long weight, int charValue)
        {
            Left = null;
            Right = null;
            Weight = weight;
    ...
    class BinaryTree
    {
        ...
        public List<byte> FindValueIndeces(List<Node> forest, long value)
        {
        ...
        public long FindMinumumWeight(List<Node> forest)
        {
            long min = forest[0].Weight;
        ...
        public Node MakeTree(List<Node> forest)
        {
            ...
            {
                long minWeight = FindMinumumWeight(forest);
    ...
    class Program
    {
        ...
        {/*/
            using (StreamWriter sw = new StreamWriter(@"C:\Users\luk19\OneDrive\Desktop\binary.in"))
            {
                sw.Write('9');
                for (int i = 0; i <= 255; i++)
                {
