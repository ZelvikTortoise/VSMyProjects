...
namespace WordProcessor2013_UnitTests {
	...
	public class ProgramTests {
		...
		public void Run_NonExistentFile() {
			...
			var result = Call_Run(new[] { "xxyyzz.txt" });
		...
		public void Run_ValidFile() {
			...
			var result = Call_Run(new[] { "validtestinputfile.txt" });
		...
		public void Run_ValidFileAndAdditionalDummyArguments() {
			...
			var result = Call_Run(new[] { "validtestinputfile.txt", "dummyargument1", "dummyargument2"});
